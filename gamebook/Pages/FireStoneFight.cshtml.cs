...
{
    public class FireStoneFightModel : PageModel
    {
            ...
            public FireStoneFightModel(ISessionStorage<GameState> ss)
            {
                _ss = ss;
